...
class FlutterCarplay {
  ...
  Future<void> updatePoiTab({required CPPointOfInterestTemplate updatedTemplate}) async {
    await _carPlayController.methodChannel.invokeMethod(
      'updatePoiTab',
      <String, dynamic>{'updatedTemplate': updatedTemplate.toJson()},
    ).then((value) {
  ...
  Future<void> updateChargingTab({required CPListTemplate updatedTemplate}) async {
    await _carPlayController.methodChannel.invokeMethod(
      'updateChargingTab',
      <String, dynamic>{'updatedTemplate': updatedTemplate.toJson()},
    ).then((value) {
  ...
  static void showAlert({
    ...
    _carPlayController.methodChannel
        .invokeMethod(CPEnumUtils.stringFromEnum(FCPChannelTypes.setAlert.toString()), <String, dynamic>{
  ...
  static void showActionSheet({
    ...
    _carPlayController.methodChannel
        .invokeMethod(CPEnumUtils.stringFromEnum(FCPChannelTypes.setActionSheet.toString()), <String, dynamic>{
      'rootTemplate': template.toJson(),
      'animated': animated,
    }).then((value) {
      if (value) {
